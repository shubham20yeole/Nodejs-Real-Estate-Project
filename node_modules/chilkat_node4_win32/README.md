...
```
npm install chilkat_node4_win32
```
...
if (os.platform() == 'win32') {  
    var chilkat = require('chilkat_node4_win32'); 
} else if (os.platform() == 'linux') {
	if (os.arch() == 'arm') {
		var chilkat = require('chilkat_node4_arm');
	} else os.arch() == 'x86') {
		var chilkat = require('chilkat_node4_linux32');
	} else {
		var chilkat = require('chilkat_node4_linux64');
    }
} else if (os.platform() == 'darwin') {
	var chilkat = require('chilkat_node4_macosx');
}
